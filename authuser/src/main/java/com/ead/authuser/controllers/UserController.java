...
public class UserController {
    ...
    @GetMapping
    public ResponseEntity<Page<UserModel>> getAllUsers(@PageableDefault(page = 0, size = 10, sort = "id", direction = Sort.Direction.ASC)
                                                       Pageable page) {
        Page<UserModel> userModelPage = userService.findAll(page);
